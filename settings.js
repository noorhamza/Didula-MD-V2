...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PRABATH-MD~t7EE1AZZ#CV0BUkjqdY7O6qs18cqpKWvofMrzJiNfb_1qxMTMxos' : process.env.SESSION_ID,
...
HEART_REACT: process.env.HEART_REACT || 'false',
    SUDO: process.env.SUDO === undefined ? '923054840098' : process.env.SUDO,
